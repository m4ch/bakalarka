...
<div style="background-image: url(gloffer.jpg);  background-repeat: no-repeat;
  background-size: auto;position: relative;width: 1920px;height:3600px; margin: 0 auto;">
<div style="position: absolute;width:530px;height:275px;top: 2750px;left:400px;">
<canvas id="newBrandsChart"></canvas>
</div>
<div style="position: absolute;width:530px;height:275px;top: 2750px;left:1000px;">
...
var chart2 = new Chart(ctx2, {
    ...
    options: {
		...
		title: { 
			display: true, 
			text: 'Top 5 nejprodavanejsi znacky',
			fontSize: 21,
			fontFamily: 'Nunito Sans'},
		tooltips: {
			bodyFontSize: 17,
